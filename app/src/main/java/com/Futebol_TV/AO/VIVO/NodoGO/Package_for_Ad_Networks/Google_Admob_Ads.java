...
public class Google_Admob_Ads {
    ...
    public Google_Admob_Ads(AppCompatActivity activity) {
        this.mActivity = activity;
    }

    public void ShowingBanner(RelativeLayout bannerContainer) {
        AdView adView = new AdView(mActivity);
        adView.setAdUnitId(AllVariables.GoogleBanner);
    ...
    public void InterAdsLoader() {
        ...
        InterstitialAd.load(mActivity, AllVariables.GoogleInter, adRequest, new InterstitialAdLoadCallback() {
            @Override
    ...
    public void NativeAdsShower(LinearLayout nativeContainer){
        AdLoader adLoader = new AdLoader.Builder(mActivity, AllVariables.GoogleNative)
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    @Override
                    public void onNativeAdLoaded(@NonNull NativeAd nativeAd) {
                        // Show the ad.
                        NativeAdView nativeAdView=(NativeAdView) mActivity.getLayoutInflater().inflate(R.layout.singular_native_for_admob,null);
